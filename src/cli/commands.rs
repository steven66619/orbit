...
/// All supported orbit subcommands.
...
pub struct List {
	...
	/// Only include packages explicitly installed with Orbit
	#[clap(short = 'N', long, action)]
	pub orbit_installed: bool,
...
pub struct Clean {
	...
	/// Removes the `orbit-sources.list` file generated by the fetch command
	#[clap(long, action)]
	pub fetch: bool,
}
